...
def relative_to_abs(rel_traj, start_pos):
    """
    Inputs:
    - rel_traj: pytorch tensor of shape (seq_len, batch, 2) 相对轨迹，<序列长度,批大小,2>
    - start_pos: pytorch tensor of shape (batch, 2)      起始位置   <批大小,2>
    Outputs:
    - abs_traj: pytorch tensor of shape (seq_len, batch, 2) 绝对轨迹  <序列长度,批大小,2>
    """
    # batch, seq_len, 2
